...
\node[anchor = south east, align = right, font = \footnotesize, gray] (paper) at (1,0.034) {Draft on \bref{https://doi.org/10.31235/osf.io/ba67n}{SocArxiv}\\Code on \bref{https://doi.org/10.7910/DVN/ASGOVU}{Dataverse}\\\emph{American Sociological Review}};
%}
\end{tikzpicture}
\end{frame}
